...
def main():
    ...
    object_initial_pose = scene.get_object_poses(['box'])['box']
    ...
    scene_objects.remove('box')
    wait_for_scene_update(scene, scene_objects,
                          expected_attached_objects=['box'])
